  ...
  if( brk.place %in% c('경상북도_울릉군')){
    ...
    if(type=='hpai'){
      if(species=='10'){
        ...
        st.func3 <- (fac_capa_clu_std$f1_chi+fac_capa_clu_std$f1_duc)/2
        st.func4 <- (fac_capa_clu_std$f2_chi+fac_capa_clu_std$f2_duc)/2
        st.func5 <- (fac_capa_clu_std$f3_chi+fac_capa_clu_std$f3_duc)/2
        st.func6 <- (fac_capa_clu_std$f4_chi+fac_capa_clu_std$f4_duc)/2
      }
    } else {
      if(species=='10'){
...
if(nrow(na.omit(brk.place[,1:2]))==1) {
  ...
  if(type=='hpai'){
    breakout_independence_rates2 <- data.frame(facility=facility_list,self_reliance1=c(eval_sol$f1_chi[1],eval_sol$f2_chi[1],eval_sol$f3_chi[1],eval_sol$f4_chi[1]), self_reliance2=c(eval_sol$f1_duc[1],eval_sol$f2_duc[1],eval_sol$f3_duc[1],eval_sol$f4_duc[1]))  
  } else {
    breakout_independence_rates2 <- data.frame(facility=facility_list,self_reliance1=c(eval_sol$f1_pig[1],eval_sol$f2_pig[1],eval_sol$f3_pig[1],eval_sol$f4_pig[1]), self_reliance2=c(eval_sol$f1_cow[1],eval_sol$f2_cow[1],eval_sol$f3_cow[1],eval_sol$f4_cow[1]))  
  }
  ...
  if(type=='hpai'){
    breakout_independence_rates2 <- data.frame(facility=facility_list,self_reliance1=c((eval_sol1$f1_chi[1]+eval_sol2$f1_chi[1])/2,(eval_sol1$f2_chi[1]+eval_sol2$f2_chi[1])/2,(eval_sol1$f3_chi[1]+eval_sol2$f3_chi[1])/2,(eval_sol1$f4_chi[1]+eval_sol2$f4_chi[1])/2) ,self_reliance2=c((eval_sol1$f1_duc[1]+eval_sol2$f1_duc[1])/2,(eval_sol1$f2_duc[1]+eval_sol2$f2_duc[1])/2,(eval_sol1$f3_duc[1]+eval_sol2$f3_duc[1])/2,(eval_sol1$f4_duc[1]+eval_sol2$f4_duc[1])/2))  
  } else {
    breakout_independence_rates2 <- data.frame(facility=facility_list,self_reliance1=c((eval_sol1$f1_pig[1]+eval_sol2$f1_pig[1])/2,(eval_sol1$f2_pig[1]+eval_sol2$f2_pig[1])/2,(eval_sol1$f3_pig[1]+eval_sol2$f3_pig[1])/2,(eval_sol1$f4_pig[1]+eval_sol2$f4_pig[1])/2) ,self_reliance2=c((eval_sol1$f1_cow[1]+eval_sol2$f1_cow[1])/2,(eval_sol1$f2_cow[1]+eval_sol2$f2_cow[1])/2,(eval_sol1$f3_cow[1]+eval_sol2$f3_cow[1])/2,(eval_sol1$f4_cow[1]+eval_sol2$f4_cow[1])/2))  
  }
  ...
  if(type=='hpai'){
    breakout_independence_rates2 <- data.frame(facility=facility_list,self_reliance1=c((eval_sol1$f1_chi[1]+eval_sol2$f1_chi[1]+eval_sol3$f1_chi[1])/3,(eval_sol1$f2_chi[1]+eval_sol2$f2_chi[1]+eval_sol3$f2_chi[1])/3,(eval_sol1$f3_chi[1]+eval_sol2$f3_chi[1]+eval_sol3$f3_chi[1])/3,(eval_sol1$f4_chi[1]+eval_sol2$f4_chi[1]+eval_sol3$f4_chi[1])/3), 
                                               self_reliance2=c((eval_sol1$f1_duc[1]+eval_sol2$f1_duc[1]+eval_sol3$f1_duc[1])/3,(eval_sol1$f2_duc[1]+eval_sol2$f2_duc[1]+eval_sol3$f2_duc[1])/3,(eval_sol1$f3_duc[1]+eval_sol2$f3_duc[1]+eval_sol3$f3_duc[1])/3,(eval_sol1$f4_duc[1]+eval_sol2$f4_duc[1]+eval_sol3$f4_duc[1])/3))  
  } else {
    breakout_independence_rates2 <- data.frame(facility=facility_list,self_reliance1=c((eval_sol1$f1_pig[1]+eval_sol2$f1_pig[1]+eval_sol3$f1_pig[1])/3,(eval_sol1$f2_pig[1]+eval_sol2$f2_pig[1]+eval_sol3$f2_pig[1])/3,(eval_sol1$f3_pig[1]+eval_sol2$f3_pig[1]+eval_sol3$f3_pig[1])/3,(eval_sol1$f4_pig[1]+eval_sol2$f4_pig[1]+eval_sol3$f4_pig[1])/3), 
                                               self_reliance2=c((eval_sol1$f1_cow[1]+eval_sol2$f1_cow[1]+eval_sol3$f1_cow[1])/3,(eval_sol1$f2_cow[1]+eval_sol2$f2_cow[1]+eval_sol3$f2_cow[1])/3,(eval_sol1$f3_cow[1]+eval_sol2$f3_cow[1]+eval_sol3$f3_cow[1])/3,(eval_sol1$f4_cow[1]+eval_sol2$f4_cow[1]+eval_sol3$f4_cow[1])/3))  
  }
...
breakout_independence_rates2$self_reliance1 <- breakout_independence_rates2$self_reliance1/100
breakout_independence_rates2$self_reliance2 <- breakout_independence_rates2$self_reliance2/100  
return(list(breakout_optimization_results, breakout_independence_rates, breakout_independence_rates2))
}
